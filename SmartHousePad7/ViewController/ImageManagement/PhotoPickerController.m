...
- (void)showImagePicker {
    ...
    UIPopoverController*pvcr=[self popoverController];
    if (pvcr.isPopoverVisible==YES) {
        [pvcr dismissPopoverAnimated:YES];
        return;
    }
    [pvcr presentPopoverFromBarButtonItem:button permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
    return;
